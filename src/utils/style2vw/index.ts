...
if (typeof window !== "undefined") {
  try {
    ...
    // extraOptions = {"allReplace":true,"unitToConvert":"px","viewportWidth":375,"unitPrecision":6,"viewportUnit":"vw","fontViewportUnit":"vw","minPixelValue":1,"attributeList":[],"include":[],"exclude":[]}
