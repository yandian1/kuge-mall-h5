<template>
  <div class="page page-grey">
    <div class="form">
      <div class="form-item">
        <div class="form-item__label">新手机号</div>
        <div class="form-item__content">
          <app-input class="input" v-model="formState.account" placeholder="请填写新手机号"/>
        </div>
      </div>
      <div class="form-item">
        ...
        <div class="form-item__content">
          <div class="verify-code-box">
            <app-input v-model="formState.code" placeholder="请填写验证码" type="number" clearable/>
            <div
              :class="{
                btn: true,
...
const setAccount = () => {
  ...
  memberApi
    .setAccount(formState)
    .then(() => {
      userStore.user.account = formState.account
      showToast('设置成功~')
      router.back()
    })
    .catch(() => {
